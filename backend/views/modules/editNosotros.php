...
$nosotros = GestorPagesController::ver_page("nosotros");
                ...
                <div class="content custom-scrollbar">
                    ...
                    <div id="e-commerce-product" class="page-layout simple tabbed">
                        ...
                        <div class="page-content">
                            ...
                            <div class="card p-3">
                                <form id="form-page" enctype="multipart/form-data" method="post" action="editNosotros">
                                    <textarea name="cuerpo"  id="mymce" rows="15" placeholder="Enter text ..."><?php echo $nosotros[0]["cuerpo"] ?></textarea>   
                                    <input type="text" name="name_page" hidden="" value="nosotros"> 
